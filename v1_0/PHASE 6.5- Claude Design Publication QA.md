...
| RAG ingestion + validation report | `<CH_ROOT>/RAG/` |
...
## 9. RAG readiness
Check chunk-friendly structure, heading quality, semantic clarity, retrieval-friendly segmentation, metadata blocks, and that the PHASE 5 validation report passed.
...
Per-format sub-certification (each Ready / Not Ready): EPUB · Kindle · Print · Audiobook · RAG
